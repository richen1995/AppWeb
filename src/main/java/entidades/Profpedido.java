...
@NamedQueries({
    ...
    , @NamedQuery(name = "Profpedido.findByPropedFecha", query = "SELECT p FROM Profpedido p WHERE p.propedFecha = :propedFecha")
...
public class Profpedido implements Serializable {
    ...
    @Column(name = "proped_fecha")
    @Temporal(TemporalType.DATE)
    private Date propedFecha;
    @Size(max = 25)
    ...
    public Date getPropedFecha() {
        return propedFecha;
    }

    public void setPropedFecha(Date propedFecha) {
        this.propedFecha = propedFecha;
    }
